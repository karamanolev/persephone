...
urlpatterns = [
    ...
    url('^projects/(\d+)/builds/(\d+)/$', views.build, name='build'),
    ...
    url('^api/v1/projects/(?P<project_id>\d+)/builds/(?P<build_number>\d+)/finish$',
        views.APIBuildFinish.as_view(), name='api_build_finish'),
    url('^api/v1/projects/(?P<project_id>\d+)/builds/(?P<build_number>\d+)/screenshots/$',
        views.APIScreenshots.as_view(), name='api_build'),
    url('^api/v1/projects/(?P<project_id>\d+)/builds/'
        '(?P<build_number>\d+)/screenshots/(?P<screenshot_name>.*)$',
